...
namespace MauiAppMillionShow
{
    public partial class App : Application
    {
        List<Question> easyQuestions = new()
        {
            ...
            {
                Id = 41,
                Statement = "What was James Bond's secret identity code?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "707"},
                    new Alternative {Correct = false, Description = "907"},
                    new Alternative {Correct = false, Description = "008"},
                    new Alternative {Correct = true,  Description = "007"}
                }
            },
            new Question
            {
                Id = 42,
                Statement = "What fruit is associated with the city of Laranjal?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Watermelon"},
                    new Alternative {Correct = true,  Description = "Orange"},
                    new Alternative {Correct = false, Description = "Apple"},
                    new Alternative {Correct = false, Description = "Grape"}
                }
            },
            new Question
            {
                Id = 43,
                Statement = "How many cents are equivalent to one real?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Ten"},
                    new Alternative {Correct = false, Description = "One thousand"},
                    new Alternative {Correct = true,  Description = "One hundred"},
                    new Alternative {Correct = false, Description = "Fifty"}
                }
            },
            new Question
            {
                Id = 44,
                Statement = "According to the Bible, what was the 'forbidden fruit'?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Papaya"},
                    new Alternative {Correct = false, Description = "Apple"},
                    new Alternative {Correct = false, Description = "Grape"},
                    new Alternative {Correct = true,  Description = "Pineapple"}
                }
            },
            new Question
            {
                Id = 45,
                Statement = "What is the name of the bridge that connects Rio de Janeiro to Niterói?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Golden Gate"},
                    new Alternative {Correct = true,  Description = "Rio-Niterói"},
                    new Alternative {Correct = false, Description = "Rio São Francisco"},
                    new Alternative {Correct = false, Description = "Brooklyn"}
                }
            },
            new Question
            {
                Id = 46,
                Statement = "In which year did the Portuguese discover Brazil?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "1450"},
                    new Alternative {Correct = true,  Description = "1500"},
                    new Alternative {Correct = false, Description = "1550"},
                    new Alternative {Correct = false, Description = "1400"}
                }
            },
            new Question
            {
                Id = 47,
                Statement = "What is measured by a thermometer?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Longitude"},
                    new Alternative {Correct = false, Description = "Humidity"},
                    new Alternative {Correct = true,  Description = "Temperature"},
                    new Alternative {Correct = false, Description = "Latitude"}
                }
            },
            new Question
            {
                Id = 48,
                Statement = "Which continent does the Amazon River belong to?",
                Alternatives = new()
                {
                    new Alternative {Correct = true,  Description = "American"},
                    new Alternative {Correct = false, Description = "African"},
                    new Alternative {Correct = false, Description = "European"},
                    new Alternative {Correct = false, Description = "Asian"}
                }
            },
            new Question
            {
                Id = 49,
                Statement = "Who carved the character Pinocchio in Carlo Lorenzini's story?",
                Alternatives = new()
                {
                    new Alternative {Correct = true,  Description = "Geppetto"},
                    new Alternative {Correct = false, Description = "Fairy"},
                    new Alternative {Correct = false, Description = "Witch"},
                    new Alternative {Correct = false, Description = "Giant"}
                }
            },
            new Question
            {
                Id = 50,
                Statement = "What is the official currency of the United States?",
                Alternatives = new()
                {
                    new Alternative {Correct = false, Description = "Escudo"},
                    new Alternative {Correct = false, Description = "Crown"},
                    new Alternative {Correct = true,  Description = "Dollar"},
                    new Alternative {Correct = false, Description = "Pound"}
                }
            }
        };
